package com.bezditnyi.homework.util;
...
public interface Constants {
    ...
    String FILE_PATH_LESSON_3 = "src/main/resources/homework/lesson3";
    String FILE_PATH_LESSON_5 = "src/main/resources/homework/lesson5";
